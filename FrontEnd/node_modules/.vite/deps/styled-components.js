...
function rt(e, r2, s2) {
  ...
  function O2(e2, r3) {
    return function(e3, r4, s3) {
      ...
      e3.warnTooManyClasses && e3.warnTooManyClasses(b3);
      var E3 = ie(p3, d2);
      return b3 && (E3 += " " + b3), v2.className && (E3 += " " + v2.className), S3[L(g3) && !A.has(g3) ? "class" : "className"] = E3, S3.ref = s3, (0, import_react.createElement)(g3, S3);
    }(D2, e2, r3);
  }
  O2.displayName = y2;
  var D2 = import_react.default.forwardRef(O2);
  return D2.attrs = S2, D2.componentStyle = N2, D2.shouldForwardProp = w2, D2.displayName = y2, D2.foldedComponentIds = i2 ? ie(a2.foldedComponentIds, a2.styledComponentId) : "", D2.styledComponentId = g2, D2.target = i2 ? a2.target : e, Object.defineProperty(D2, "defaultProps", { get: function() {
